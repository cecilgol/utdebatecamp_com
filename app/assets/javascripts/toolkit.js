 + function(t) {
    ...
    function e(e) {
        return this.each(function() {
            var i = t(this),
                n = i.data("bs.enter"),
                s = t.extend({}, o.DEFAULTS, i.data(), "object" == typeof e && e);
            n || i.data("bs.enter", n = new o(this, s)), "string" == typeof e && n[e]()
        })
    }
    var i = '[data-transition="entrance"]',
        o = function(e, i) {
            t.support.transition && (this.element = e, this.options = i, this.handler = null, this.addEventListeners())
        };
    ...
    }, o.prototype.checkForEnter = function() {
        var e = window.innerHeight,
            i = this.element.getBoundingClientRect();
        e - i.top >= 0 && setTimeout(t.proxy(this.triggerEntrance, this), this.options.delay)
    }, o.prototype.triggerEntrance = function() {
    ...
    var n = t.fn.enter;
    t.fn.enter = e, t.fn.enter.Constructor = o, t.fn.enter.noConflict = function() {
        return t.fn.enter = n, this
    }, t(function() {
        t(i).enter()
    })
}(jQuery), + function(t) {
    ...
    e.prototype.listen = function() {
        ...
        var e = this._fullWidth,
            ...
            r = e / o,
            l = a / s;
        this._imgScaleFactor = a > e && s > o ? n : l > r ? s / o * n : a / e * n
